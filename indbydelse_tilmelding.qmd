...
*`r paste("<i>[Hørning Bordtennisklub](http://hoerningbtk.dk){target=_blank},", "i samarbejde med [Bordtennis Danmark](https://bordtennisdanmark.dk){target=_blank},</i>")` indbyder til det 9. DANSKE MESTERSKABER I PING PONG `r "{{< var var.afholdelsesår >}}"` (bordtennis på lige vilkår med sandpapirsbat) samt efterfølgende FEST OM AFTENEN lørdag `r paste("{{< var var.afholdelsesdag >}}", "{{< var var.afholdelsesår >}}", "i", "[{{< var var.lokation_sted >}}]({{< var var.lokation_link >}})")`. ALLE kan deltage (uanset alder, køn, niveau eller licens)*[^1].\
...
data.frame(
  ...
  "<i class=bi-person-fill></i>&nbsp;Maks." = c(
    ...
    "200"),
  check.names = F) %>%
  kbl(col.names = NA, align = "lrr", escape = F, format = "html", 
...
tbl_tidsplan <- data.frame(
  "Tidspunkt" = c(
    ...
    "Fra kl. 19:00"),
  "Type" = c(
    "<a href=indbydelse_tilmelding.qmd#dm-i-ping-pong style=color:#000000>DM i Ping Pong 2023</a>",
    "Check-in",
    "Puljespil",
    "A-/B-slutspil",
...
2.  `r "[Ratingopdateringen i bordtennis](https://bordtennisportalen.dk/DBTU/Ranglister){target=_blank}"` pr. 09.06.2023.
...
-   Potentiel præmiesum på `r tbl1_præmier_penge[1, 3]` fordeles på seks placeringer som følger:

```{r}
library(kableExtra)
data.frame(
  " " = c(
    tbl1_præmier_penge[1, 1],
    tbl1_præmier_penge[2, 1],
    tbl1_præmier_penge[3, 1],
    tbl1_præmier_penge[4, 1],
    tbl1_præmier_penge[5, 1],
    tbl1_præmier_penge[6, 1],
    tbl1_præmier_penge[7, 1],
    tbl1_præmier_penge[8, 1],
    tbl1_præmier_penge[9, 1]),
  "Potentiel" = c(
    tbl1_præmier_penge[1, 3],
    tbl1_præmier_penge[2, 3],
    tbl1_præmier_penge[3, 3],
    tbl1_præmier_penge[4, 3],
    tbl1_præmier_penge[5, 3],
    tbl1_præmier_penge[6, 3],
    tbl1_præmier_penge[7, 3],
    tbl1_præmier_penge[8, 3],
    tbl1_præmier_penge[9, 3]),
  "Pct." = c(
    tbl1_præmier_penge[1, 4],
    tbl1_præmier_penge[2, 4],
    tbl1_præmier_penge[3, 4],
    tbl1_præmier_penge[4, 4],
    tbl1_præmier_penge[5, 4],
    tbl1_præmier_penge[6, 4],
    tbl1_præmier_penge[7, 4],
    tbl1_præmier_penge[8, 4],
    tbl1_præmier_penge[9, 4]),
  check.names = F) %>%
...
*`r paste("ALLE kan deltage. Tilmeldingsfristen er", sub('^0+', '', format(dmy(tbl0_input$k_tilmeldingsfrist), '%d. %B %Y.')), "Først til mølle-princip. Ved tilmelding modtages bekræftelsesmail (tilmelding er ikke bindende, hvorfor evt. refusion er muligt). Tilmelding foregår herunder <i class=bi-tags-fill></i>")`*
