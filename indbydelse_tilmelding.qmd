...
subtitle: "DM i Ping Pong {{< var var.afholdelsesår >}}<br><i class=small> {{< var var.afholdelsesdag >}} i [{{< var var.lokation_sted >}}]({{< var var.lokation_link >}})</i>"
editor_options: 
...
tbl_tidsplan <- data.frame(
  "Tidspunkt" = c(
    ...
    "Fra kl. 19:00"),
  "Type" = c(
    "<a href=indbydelse_tilmelding.qmd#dm-i-ping-pong-2023 style=color:#000000>DM i Ping Pong 2023</a>",
    "Check-in",
    "Puljespil",
    "A-/B-slutspil",
