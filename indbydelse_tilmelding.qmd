...
*`r paste("<i>[Hørning Bordtennisklub](http://hoerningbtk.dk){target=_blank},", "i samarbejde med [Bordtennis Danmark](https://bordtennisdanmark.dk){target=_blank},</i>")` indbyder til det 9. DANSKE MESTERSKABER I PING PONG 2023 (bordtennis på lige vilkår med sandpapirsbat) samt efterfølgende FEST OM AFTENEN lørdag 17. juni. ALLE kan deltage (uanset alder, køn, niveau eller licens)*[^1]*.\
...
data.frame(
  ...
  footnote(
    "<i style=font-size:80%>Mikrogebyrer pålægges alle priser",
