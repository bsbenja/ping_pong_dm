...
viewof k_tilmeldingstype = Inputs.checkbox(
  ...
  {value: ["🎫 Ordinær", "🏃 Drive-in"], label: " 🎫 Tilmeldingstype"}
)
...
viewof k_billetsalg_pr_tilmelding = Inputs.checkbox(
  ...
  {value: ["1 stk. billetsalg", "2 stk. billetsalg", "3 stk. billetsalg", "4 stk. billetsalg"], label: "🎫 Billetsalg pr. tilmelding"}
)

viewof k_gentilmelding = Inputs.checkbox(
  ["Debutant", "Gentilmelding", "❌ Afbud"], 
  {value: ["Debutant", "Gentilmelding"], label: "🔃 Gentilmeldinger"}
)
