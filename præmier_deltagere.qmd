...
```{r}
if(tbl0_input$k_tilmelding_status == 3) { kbl2_deltagere_foreløbig }

if(tbl0_input$k_tilmelding_status == 1 | tbl0_input$k_tilmelding_status == 2 | tbl0_input$k_tilmelding_status == 4) { kbl2_deltagere_puljer }

if(tbl0_input$k_tilmelding_status == 1 | tbl0_input$k_tilmelding_status == 2 | tbl0_input$k_tilmelding_status == 4) { kbl2_deltagere_fest }
```
